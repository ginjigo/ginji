...
func TestBasicAuth(t *testing.T) {
	...
	app.Get("/protected", func(c *ginji.Context) {
		username := c.GetString("user")
		_ = c.JSON(ginji.StatusOK, ginji.H{"user": username})
	})
...
func TestBearerAuth(t *testing.T) {
	...
	app.Get("/api/data", func(c *ginji.Context) {
		user, _ := c.Get("user")
...
func TestAPIKey(t *testing.T) {
	...
	app.Get("/api/resource", func(c *ginji.Context) {
		user, _ := c.Get("user")
		_ = c.JSON(ginji.StatusOK, user)
	})
...
func TestAPIKeyQueryParam(t *testing.T) {
	...
	app.Get("/api/test", func(c *ginji.Context) {
		_ = c.Text(ginji.StatusOK, "ok")
	})
...
func TestRequireRole(t *testing.T) {
	...
	app.Get("/admin/panel", func(c *ginji.Context) {
		_ = c.Text(ginji.StatusOK, "admin panel")
	})
...
func TestRequireRoleWithRolesArray(t *testing.T) {
	...
	app.Get("/moderate", func(c *ginji.Context) {
		_ = c.Text(ginji.StatusOK, "moderation panel")
	})
