...
func TestTimeoutSuccess(t *testing.T) {
	...
	app.Get("/fast", func(c *ginji.Context) {
		// Fast handler that completes quickly
		_ = c.Text(ginji.StatusOK, "success")
	})
...
func TestTimeoutExceeded(t *testing.T) {
	...
	app.Get("/slow", func(c *ginji.Context) {
		// Slow handler that exceeds timeout
		time.Sleep(200 * time.Millisecond)
		_ = c.Text(ginji.StatusOK, "should not reach")
	})
...
func TestTimeoutSkipFunc(t *testing.T) {
	...
	app.Get("/slow", func(c *ginji.Context) {
		time.Sleep(100 * time.Millisecond)
		_ = c.Text(ginji.StatusOK, "completed")
	})
...
func TestTimeoutContext(t *testing.T) {
	...
	app.Get("/check-context", func(c *ginji.Context) {
...
func TestTimeoutNoTimeout(t *testing.T) {
	...
	app.Get("/instant", func(c *ginji.Context) {
		// Handler completes immediately
		_ = c.JSON(ginji.StatusOK, ginji.H{"status": "ok"})
	})
